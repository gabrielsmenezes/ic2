...
def imprime_contribuidores_em_comum(codeSamples,contribuidoresDoFramework):
	for codeSample in codeSamples:
		...
		contribuidoresDoSample = dictToSet(contribuidoresDoSample.keys())
...
contribuidoresDoSpring = dictToSet(contribuidoresDoSpring.keys())
contribuidoresDoAndroid = dictToSet(contribuidoresDoAndroid.keys())
